...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent assistant helping Contoso Inc employees with their healthcare plans, the employee handbook, the role library or the resume documents questions. " \
